...
const ProductPage = () => {
  ...
  return (
    <div className="px-4 md:px-12 bg-[#F8F9FA]">
      <p
        className="cursor-pointer py-3 text-gray-800 font-medium"
        onClick={() => router.back()}
      >
        &larr; Back
      </p>
      ...
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-center md:space-x-10">
        ...
        <div className="basis-1/2 py-8">
          ...
          <p className="font-semibold mt-10 text-lg text-gray-900">
            Description
          </p>
      ...
      <h2 className="w-full text-2xl font-semibold pt-20 text-gray-900">
        You might also like
      </h2>
      <ProductList />
    </div>
